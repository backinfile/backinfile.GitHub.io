...
canvas.style.backgroundColor = 'rgba(0,39,75,0.9)';
document.body.appendChild(div);
var ctx = canvas.getContext('2d');
var grd=ctx.createRadialGradient(width/2,height*6/5,1,width/2,height*5/4,height*9/5);
grd.addColorStop(0,"rgba(0,220,255,1)");
grd.addColorStop(1,'rgba(0,50,100,1)');
ctx.rect(0,0,width,height);
ctx.fillStyle = grd;
ctx.fill();
function bluerect(x,y,w,h) {
...
du.yue.PaletteTop = function()
{
	...
	// dataVo 
	var _start = false,_mode = 0,_className = "my-palette";// mode:0-div模式 1-canvas模式
	...
	{
		// 给doc绑定鼠标按下事件
		document.addEventListener("mousedown", function(){ _PaletteEvent.docMouseDownEvent.apply(this, [_start, _className, _OutDiv, _setColor]); });
	}
	// 执行事件绑定方法
	function _fire()
	{
	...
	function _createModelDivs()
	{
		...
		for(var a = 0;a<colors.length;a++)
		{
			...
			// 绑定色块单击事件
			modelDiv.addEventListener("click", function(){ _PaletteEvent.modelDivClickEvent.apply(this, [_changeByModel]); });
		}
	}
	// 初始化canvas
	...
	function _bindEvent_0()
	{
		...
		// 最外框阻止冒泡
		_OutDiv.addEventListener("mousedown", function(){ _PaletteEvent.outDivMouseDownEvent.apply(this, [_PaletteVo, _HueVo, _TransparentVo]); });
		// 阻止右键默认事件 需要直接绑定 
		_OutDiv.oncontextmenu = function(){ return _PaletteEvent.outDivContextMenuEvent.apply(this); };
		// 色盘区域 单击，移动事件
		_PaletteOutDiv.addEventListener("mousedown", function(){ _PaletteEvent.paletteOutDivMouseDownEvent.apply(this, [_selectByPalette]); });
		_MidBarHueOutDiv.addEventListener("mousedown", function(){ _PaletteEvent.midBarHueOutDivMouseDownEvent.apply(this, [_selectByHue]); });
		_MidBarTransOutDiv.addEventListener("mousedown", function(){ _PaletteEvent.midBarTransOutDivMouseDownEvent.apply(this, [_selectByTrans]); });
	...
	function _addUserDefinedColor()
	{
		...
		modelDiv.addEventListener("click", function(){ _PaletteEvent.modelDivClickEvent.apply(this, [_changeByModel]); });
		// 绑定右键删除事件
		modelDiv.addEventListener("contextmenu", function(){ _PaletteEvent.modelDivContextMenuEvent.apply(this); });
	}
}
/**
 * 事件类
...
du.yue.PaletteEvent = function()
{
	...
	Object.defineProperties(this, {
		...
		outDivMouseDownEvent : { writable : false, value : _outDivMouseDownEvent },
		outDivContextMenuEvent : { writable : false, value : _outDivContextMenuEvent },
		paletteOutDivMouseDownEvent : { writable : false, value : _paletteOutDivMouseDownEvent },
		midBarHueOutDivMouseDownEvent : { writable : false, value : _midBarHueOutDivMouseDownEvent },
		midBarTransOutDivMouseDownEvent : { writable : false, value : _midBarTransOutDivMouseDownEvent },
		...
		modelDivClickEvent : { writable : false, value : _modelDivClickEvent },
		modelDivContextMenuEvent : { writable : false, value : _modelDivContextMenuEvent },
...
du.yue.PaletteDom = function()
{
	var _PaletteUtil = du.yue.PaletteUtil;
	Object.defineProperties(this, {
		getOutDiv : { writable : false, value : _getOutDiv },
		getPaletteOutDiv : { writable : false, value : _getPaletteOutDiv },
		getPaletteInnDiv : { writable : false, value : _getPaletteInnDiv },
		getPaletteCanvas : { writable : false, value : _getPaletteCanvas },
		getPaletteCircleDiv : { writable : false, value : _getPaletteCircleDiv },
		getMidOutDiv : { writable : false, value : _getMidOutDiv },
		getMidShowCanvas : { writable : false, value : _getMidShowCanvas },
		getMidBarOutDiv : { writable : false, value : _getMidBarOutDiv },
		getMidBarHueOutDiv : { writable : false, value : _getMidBarHueOutDiv },
		getMidBarCircleDiv : { writable : false, value : _getMidBarCircleDiv },
		getMidBarHueDiv : { writable : false, value : _getMidBarHueDiv },
		getMidBarHueCanvas : { writable : false, value : _getMidBarHueCanvas },
		getBottomOutDiv : { writable : false, value : _getBottomOutDiv },
		getBottomLabelDiv : { writable : false, value : _getBottomLabelDiv },
		getBottomInputDiv : { writable : false, value : _getBottomInputDiv },
		...
		getBottomChangeDiv : { writable : false, value : _getBottomChangeDiv },
		getBottomChangeCanvas : { writable : false, value : _getBottomChangeCanvas },
		getBottomQuickOutDiv : { writable : false, value : _getBottomQuickOutDiv },
		getBottomQuickModelOutDiv : { writable : false, value : _getBottomQuickModelOutDiv },
		getBottomQuickModelDiv : { writable : false, value : _getBottomQuickModelDiv },
		getBottomDefineOutDiv : { writable : false, value : _getBottomDefineOutDiv },
